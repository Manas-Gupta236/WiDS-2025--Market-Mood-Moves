...
- `week1/` – It has 6 jupyter notebooks which includes basic Python programming, market data extraction and handling/processing and sentiment analysis foundations
